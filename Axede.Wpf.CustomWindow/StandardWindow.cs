...
namespace Axede.WPF.CustomWindow
{
    public class StandardWindow : Window
    {
        ...
        protected LinearGradientBrush oLinearBackground;
        ...
        protected void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            this.Height = this.Height - 1;
             ...
             oLinearBackground = new LinearGradientBrush();
                oLinearBackground.StartPoint = new Point(0, 0);
                oLinearBackground.EndPoint = new Point(0, 1);
                Color oColorInicio = (Color)ColorConverter.ConvertFromString("#FF717B80");
                Color oColorFin = (Color)ColorConverter.ConvertFromString("#29456A");
                oLinearBackground.GradientStops.Add(new GradientStop(oColorInicio, 0));
                oLinearBackground.GradientStops.Add(new GradientStop(oColorFin, 0.3));

                _captionControl.Background = oLinearBackground;
            ...
            //{
                ...
                _contentWindowBackgroundBorder.CornerRadius = new CornerRadius(5); ;
                _contentWindowBorder.CornerRadius = new CornerRadius(5);

               
                //_captionControl.Height = 15;
                ...
                _windowBorderBorder.BorderThickness = new Thickness(1);
                _windowBorderBorder.Child = (UIElement)content;
                _windowBorderBorder.BorderBrush = oLinearBackground;
                _windowBorderBorder.CornerRadius = new CornerRadius(5);
                _windowBorderBorder.Background = Brushes.Black;
                ...
                borderWhite.CornerRadius = new CornerRadius(5);
               
                //_captionControl.Child = oLableTitle;

                _captionControl.VerticalAlignment = System.Windows.VerticalAlignment.Center;
                ...
                //borderBlack.CornerRadius = new CornerRadius(5);

                // put the content back
                base.Content = borderWhite;
                ...
                TextBlock.SetFontFamily(_captionControl, new FontFamily("Verdana"));
                TextBlock.SetFontSize(_captionControl, 11);
                TextBlock.SetFontStyle(_captionControl, SystemFonts.CaptionFontStyle);
                TextBlock.SetFontWeight(_captionControl,FontWeights.SemiBold);


                // create window resizing
                _resizingAdorner = new WindowResizingAdorner((UIElement)base.Content, this);
                if (AdornerLayer.GetAdornerLayer((UIElement)this.Content)!=null)
        ...
        protected void StandardWindow_StateChanged(object sender, EventArgs e)
        {
            ...
            if (this.WindowState == WindowState.Normal)
            {
                ...
                TextBlock.SetForeground(_captionControl, Brushes.White);   // title color in normal window is black
        ...
        protected virtual void OnCaptionBarClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (e.LeftButton == System.Windows.Input.MouseButtonState.Pressed)
            {
                ...
                {
                    if (MinimizeButtonState != WindowButtonState.None)
                    {
        ...
        protected virtual void OnStandardWindowActivated(object sender, EventArgs e)
        {
            ...
            if (this.WindowState == WindowState.Maximized)
                ...
                TextBlock.SetForeground(_captionControl, Brushes.White);  // caption text color when window is active

            if (!_aeroEnabled)
            {
                _captionControl.Background = oLinearBackground;                   // caption background color is managed automatically by Aero if enabled
                _windowBorderBorder.BorderBrush = oLinearBackground;
            }
        }
        ...
        protected virtual void OnStandardWindowDeactivated(object sender, EventArgs e)
        {
            ...
            TextBlock.SetForeground(_captionControl, Brushes.White);    // caption text color when window is inactive
