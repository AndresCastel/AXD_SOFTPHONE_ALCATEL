...
namespace Axede.Utilidades
{
    public static class FlashWindow
    {
        ...
        public static bool Flash(System.Windows.Window winWPF, uint count = 20)
        {
            IntPtr hwnd = new System.Windows.Interop.WindowInteropHelper(winWPF).Handle;

            return Flash(hwnd, count);
        }
